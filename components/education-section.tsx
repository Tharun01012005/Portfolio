  ...
  const educationData = [
    {
      ...
      period: "2023 - 2026",
      grade: "6.22 CGPA (till 4th sem)",
      status: "Current",
      description:
        "Currently pursuing Bachelor's degree in Information Technology with focus on modern web technologies and software development.",
    },
    {
