...
export function HeroSection({ scrollToSection }: HeroSectionProps) {
  ...
  const openResume = () => {
    window.open("https://drive.google.com/file/d/1dPCJkYWD3lDWCrR-RZmNLKsaoYkWtPQU/view?usp=sharing", "_blank")
  }
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              >
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/1751611148718.jpg-dBY5QuAXVLLW5sRueY3I3Cp4EjkFir.jpeg"
