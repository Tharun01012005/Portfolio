          ...
          >
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                {["HTML/CSS", "JavaScript", "MongoDB", "Python", "Git & GitHub", "MULTISIM Software"].map((skill) => (
                  <motion.div
                    key={skill}
                    className={`border-2 rounded-lg px-4 py-3 text-center transition-all duration-300 ${
                      isDark
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {["Web Development", "UI/UX"].map((interest) => (
                  <motion.span
                    key={interest}
